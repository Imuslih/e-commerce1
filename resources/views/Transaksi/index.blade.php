                                ...
                                <div class="modal-body">
                                    <div class="card text-center mb-3">
                                        <div class="card-body" style="height:auto;">
                                            <h3>{{ $item->name }}</h3>
                                            <h5 class="card-subtitle mb-2 text-muted"><i>Category : {{ $item->category->name }}</i></h5>
                                            <h6 class="text-left">Rp. {{ number_format($item->price,0,',','.') }}</h6>
                                            <p style="background-color: aqua"><b>Spesifikasi</b></p>
                                            <p class="text-left">{{ $item->specification }}</p>
                                            <p style="background-color: aqua"><b>Deskripsi</b></p>
